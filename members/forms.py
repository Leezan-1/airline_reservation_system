...
class SignUpForm(forms.Form):
    ...
    mobile = forms.CharField(required=True, max_length=10, validators=[RegexValidator(
    ...
    confirm_password = forms.CharField(
        required=True, max_length=20, widget=forms.PasswordInput())
    ...
    def save(self):
        ...
        #   This creates User for authentication
        ...
        # This creates UserProfile to add addtional data for User
